  ...
  let navigate=useNavigate();
    ...
    return(
       <>
         ...
         <Button variant="contained" onClick={()=>navigate("/user/newPassword")} style={{backgroundColor:"#02C873",color:"white",marginTop:"30px",width:"174px",height:"56px",textTransform:"capitalize",borderRadius:"6px"}}>
           Back to Home Page
         </Button>
